...
hl.window_rule({ match = { initial_title = "Picture in picture", initial_class = "zoom" }, float = true})
...
-- hl.bind("SUPER + SHIFT + Q", hl.dsp.window.signal({ signal = "SIGKILL" })) TODO Wait until force kill works 
